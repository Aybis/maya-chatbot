...
import {
  ...
  CaretDown, Check, Users, Lightning, Building, NotePencil, Key, Scroll, SquaresFour, PlugsConnected,
...
const navItems = [
  ...
  { to: '/app/admin', icon: SquaresFour, label: 'Admin' },
  { to: '/app/mcp', icon: PlugsConnected, label: 'MCP' },
